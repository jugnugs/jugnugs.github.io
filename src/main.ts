    ...
    messages: {
        ...
        ja: {
            ...
            "Description": {
                ...
                "bio": "HTMLとCSSを子供の頃に学んで以来、10年以上ウェブフロントエンドの開発に携わってきました。現在は東京を拠点とし、フロントエンド開発を中心にしたソフトウェアエンジニアとして活動しています。ここまではReactやVueを使った開発がメインですが、C#やSQLなどのバックエンド技術の経験もあります。クリーンなインターフェースの作成とレスポンシブデザインの実現に情熱を注いでいます。創造力を発揮できるプロジェクトに取り組むことに前向きですので、何か一緒に協力したいプロジェクトがあれば、お気軽にご連絡ください！"
            },
            "Skills": {
                "resume": "レジュメはこちら"
            },
